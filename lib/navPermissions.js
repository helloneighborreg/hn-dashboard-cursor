import { CHECKLIST_ITEMS } from './formsNav';
...
export const PERMISSION_ITEMS = [
	...
	{ href: '/settings/checklists', label: 'Checklists', group: 'Settings' },
	...CHECKLIST_ITEMS.map((form) => ({
		href: form.href,
		label: form.label,
		group: 'Settings',
	})),
	...
	{ href: '/billpay', label: 'Billpay', group: 'Financials' },
...
const DEFAULT_VISIBILITY = {
	...
	'/settings/checklists': { admin: true, nonAdmin: false },
	...Object.fromEntries(
		CHECKLIST_ITEMS.map((form) => [form.href, { admin: true, nonAdmin: false }]),
	),
	'/financials': { admin: true, nonAdmin: false },
	'/transactions': { admin: true, nonAdmin: false },
	'/reports': { admin: true, nonAdmin: false },
	'/billpay': { admin: true, nonAdmin: false },
...
export const API_PATH_PERMISSION_KEYS = [
	...
	{ prefix: '/api/billpay', key: '/billpay' },
