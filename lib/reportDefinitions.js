...
export const REPORT_TYPES = [
	{
		...
		description: 'Per-reservation owner statement with revenue, fees, and payout balances — aligned with Hospitable owner statement / co-host payout reporting.',
	},
	{
		id: 'net-cash-flow',
		label: 'Net Cash Flow',
...
export function normalizeReportId(value) {
	...
	return REPORT_TYPES.some((r) => r.id === id) ? id : REPORT_TYPES[0].id;
}
