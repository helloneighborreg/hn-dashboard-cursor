import { TASK_TAB_PATHS, TASK_TAB_LABELS, TASK_TAB_ORDER } from './taskRoutes';
...
export const CLEANER_PATH_PREFIXES = ['/tasks', '/forms'];
...
export const NAV_ITEMS = [
	...
	...TASK_TAB_ORDER.map((tab) => ({
		href: TASK_TAB_PATHS[tab],
		label: TASK_TAB_LABELS[tab],
		roles: tab === 'unassigned' ? [ROLES.ADMIN] : [ROLES.ADMIN, ROLES.CLEANER],
		parent: '/tasks',
	})),
