...
function isSectionComplete(section, errors) {
	return (!section.checklist || !errors[section.checklist.id])
...
export function isRoomGroupComplete(group, errors) {
	return group.sections.every((section) => isSectionComplete(section, errors));
}
